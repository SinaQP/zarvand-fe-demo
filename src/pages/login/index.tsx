...
const Login: FC = () => {
   ...
   const MainEntries = {
      ...
      CHANGE_PHONE_NUMBER: (
         // <PhoneNumberEntry headingText="برای کد ملی شما شماره‌ای در سیستم موجود نیست. لطفاً شماره تماس مرتبط با این کد ملی را وارد کنید." />
         <PhoneNumberEntry headingText="لطفا شماره تماس خود را وارد نمایید" />
      ),
   };
   return (
      <section>
