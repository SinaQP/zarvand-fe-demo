...
const VerificationCodeEntry: FC = () => {
   ...
   useEffect(() => {
      const progressBar:HTMLDivElement = document.getElementById("progress-bar")! as HTMLDivElement;
      ...
      const timerInterval = setInterval(() => {
         ...
         counter.style.transform = `rotate(${(100 - remainingPercentage) * 3.6}deg)`;
         progressBar.style.background =  `conic-gradient(#E3FE55 ${(100 -remainingPercentage) * 3.6}deg, #EBF5F8 0deg)`;
         if(remainingTime <= 0){
   ...
   return (
      <div className="verification-code-entry">
         <div className="verification-code-entry__timer">
            <div className="verification-code-entry__progress-bar" id="progress-bar"></div>
            <span className="verification-code-entry__counter" id="counter"></span>
            <span className="verification-code-entry__title">لطفا کد ارسال شده را وارد نمایید</span>
            <Form
